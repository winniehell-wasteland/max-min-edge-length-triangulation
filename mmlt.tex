...
\begin{definition}[Short Segments]\label{def:short_segments}
...
\begin{algorithm}
  ...
  \While{\lb < \ub}{
    ...
    for \(\gls{Sshort}[(P,|S_P[\ub]|)]\) \linebreak
    without using any segment from \(\gls{Sshort}[(P,|S_P[\mid]|)]\) \;
