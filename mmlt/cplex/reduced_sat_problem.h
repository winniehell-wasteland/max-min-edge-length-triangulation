#pragma once
#ifndef MMLT_CPLEX_REDUCED_SAT_PROBLEM_H
#define MMLT_CPLEX_REDUCED_SAT_PROBLEM_H
...
{
public:
    ReducedSATProblem(const IntersectionGraph& igraph,
...
#endif // MMLT_CPLEX_REDUCED_SAT_PROBLEM_H
